...
public class CodingNomadConfiguration {
    ...
    @Bean OS os() {
        return OS.builder().name("WSL2 - Ubuntu").verison("20.04").build();
    }

    @Bean SSDHarddrive ssdHarddrive() {
        return SSDHarddrive.builder().name("Western Digital").capacity("500GB").build();
    }
}
